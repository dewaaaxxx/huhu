...
double CalculateRequiredPower(double totalDist) {
    // ================================================================
    // PAKE FRICTION DARI GAME (BUKAN 196)
    // ================================================================
    ...
    double p = sqrt(2.0 * deceleration * totalDist) * 4.0;
    
    // ================================================================
    // POWER ADAPTIF BERDASARKAN JARAK
    // ================================================================
    if (totalDist < 50.0) {
        p *= 0.85;
    ...
    void ScanSlow(double angleStep = 0.01f) {
        ...
        while (steps < 20 && currentScanAngle < maxAngle) {
            ...
            std::vector<double> powers = { 
                CalculateRequiredPower(50.0),   // Tap-in
                CalculateRequiredPower(100.0),  // Shot deket
                CalculateRequiredPower(150.0),  // Shot sedang
                CalculateRequiredPower(250.0),  // Shot jauh
                CalculateRequiredPower(350.0),  // Shot sangat jauh
                (double)powerMax                // Max power
            };                   
